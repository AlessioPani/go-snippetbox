...
func main() {
	...
	// The others are very CPU intensive, so omitting them helps ensure that our server will remain performant
	// under heavy loads.
	...
	// Start the server using the local TLS certificate and key.
...
// openDB opens and verifies a SQLite connection pool for the provided DSN.
